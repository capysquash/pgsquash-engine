...
* Being respectful of differing skill levels and learning curves
...
* Dismissing or attacking contributors for asking questions or needing help
* Spamming issues, pull requests, or discussions with off-topic content
...
using an official project email address, posting via an official social media
...
1. **Creating a GitHub Issue** with the "Code of Conduct Violation" label (if appropriate)
...
* Description of the incident, including date and time
* Any relevant context or additional information
* Links to relevant issues, comments, or other artifacts (if applicable)
...
If you have questions about this Code of Conduct, please open an issue or reach
out to the maintainers through GitHub.

---

**Remember**: A healthy, welcoming community makes better software. Let's build
