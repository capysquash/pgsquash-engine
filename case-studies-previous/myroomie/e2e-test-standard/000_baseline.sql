...
-- Generated at: 2025-11-07T11:29:50+02:00
...
DECLARE
  ...
  faq_count INTEGER;
BEGIN
  SELECT COUNT(*) INTO email_count FROM email_templates;
  SELECT COUNT(*) INTO notification_count FROM notification_templates;
  SELECT COUNT(*) INTO personality_count FROM mbti_personality_types;
  SELECT COUNT(*) INTO lifestyle_count FROM lifestyle_preference_options;
  SELECT COUNT(*) INTO error_count FROM error_messages;
  SELECT COUNT(*) INTO faq_count FROM faq_content;
  RAISE NOTICE '========================================';
  RAISE NOTICE 'MIGRATION 30 COMPLETED - Content Seeded';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Seeded data summary:';
  RAISE NOTICE '  - Email Templates: % records', email_count;
  RAISE NOTICE '  - Notification Templates: % records', notification_count;
  RAISE NOTICE '  - MBTI Personality Types: % records', personality_count;
  RAISE NOTICE '  - Lifestyle Preference Options: % records', lifestyle_count;
  RAISE NOTICE '  - Error Messages: % records', error_count;
  RAISE NOTICE '  - FAQ Content: % records', faq_count;
  RAISE NOTICE 'All content supports multi-language (en locale)';
